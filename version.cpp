...
gadmm_version::gadmm_version()
{
	QSettings settings;
     ...
     qDebug()<<"gadmm_version created."<<endline;
}

void gadmm_version::onlineCheck(bool forced)
...
void gadmm_version::requestReceived(QNetworkReply* reply){
    QString replyText;
   	QSettings settings;
